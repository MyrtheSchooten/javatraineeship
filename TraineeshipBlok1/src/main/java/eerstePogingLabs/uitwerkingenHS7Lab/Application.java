package eerstePogingLabs.uitwerkingenHS7Lab;
...
public class Application {
    public static void main(String[] args) {
        ...
        BankAccount account2 = new BankAccount(234);
        BankAccount account3 = new BankAccount(345);
        BankAccount account4 = new BankAccount(456);
        BankAccount account5 = new BankAccount(567);
        BankAccount account6 = new BankAccount(678);
        BankAccount account7 = new BankAccount(789);
        BankAccount account8 = new BankAccount(890);
        BankAccount account9 = new BankAccount(901);
        BankAccount account10 = new BankAccount(101);
